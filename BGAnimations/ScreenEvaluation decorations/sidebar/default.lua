  ...
  local t =
    ...
    Def.GraphDisplay {
      ...
      BeginCommand = function(self)
        ...
        self:zoom(0.8)
        self:xy(-40, 262)
        self:zoomx(0.91 * 0.8):zoomy(0.8* 0.8)
      end,
...
function scoreBoard(pn, position)
  ...
  t[#t + 1] = Def.ActorFrame {
    ...
    Def.Quad {
      InitCommand = function(self)
        self:xy(frameX - 12, frameY - 35):zoomto(capWideScale(320,360)/2.2,20):halign(0):valign(0)
        self:diffusealpha(0)
      end,
    ...
    LoadFont("Common Large") ..
    {
      Name = "LongerText",
      InitCommand = function(self)
        self:xy(frameX-12,frameY-35):zoomx(0.40):zoomy(0.45):halign(0):valign(0):maxwidth(capWideScale(320,360))
      end,
      BeginCommand = function(self)
        self:queuecommand("Set")
      end,
      SetCommand = function(self)
        self:diffuse(getGradeColor(score:GetWifeGrade()))
        self:settextf("%05.5f%% (%s)", notShit.floor(score:GetWifeScore() * 1000000) / 10000, "Wife")
      end,
      ScoreChangedMessageCommand = function(self)
        self:queuecommand("Set")
      end,
  ...
  t[#t + 1] =
    ...
    {
      InitCommand = function(self)
        self:xy(frameX - 12, frameY + 22):zoom(0.40):halign(0):maxwidth(500)
      end,
      BeginCommand = function(self)
        self:queuecommand("Set")
      end,
  ...
  LoadFont("Common Large") ..
    {
      InitCommand = function(self)
        paRatio = self
        self:xy(frameWidth + frameX-190, frameY + 165):zoom(0.2):halign(1):diffuse(byJudgment(judges[2]))
  ...
  for i = 1, #fart do
    t[#t + 1] =
      ...
      {
        InitCommand = function(self)
          self:xy(frameX-12, frameY + 225 + 10 * i):zoom(0.4):halign(0):settext(fart_translated[fart[i]])
        end
      }
    t[#t + 1] =
      LoadFont("Common Normal") ..
...
t[#t + 1] = LoadActorWithParams("../../offsetplot",
  {
    plotWidth = SCREEN_WIDTH-222,
    plotHeight = 70,
    plotX = SCREEN_WIDTH / 2 + 111,
    plotY = SCREEN_HEIGHT - 56 - 70 / 2
  }
)
