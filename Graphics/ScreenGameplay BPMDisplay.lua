...
local displaySingle = Def.ActorFrame{
	...
	LoadFont("BPMDisplay", "bpm")..{
		...
		InitCommand=function(self)
			self:xy(SCREEN_CENTER_X-160-90+2, SCREEN_TOP+160+(36/2)+8)
			self:zoom(0.675):shadowlength(1);
			self:finishtweening():maxwidth(128):horizalign(left):strokecolor(Color("Outline"));
			self:addx(320):zoomx(0):decelerate(0.35):addx(-320):zoomx(1)
		end;
	};
